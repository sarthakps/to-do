...
public abstract class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    private onSwipeDeleteButtonListener listener;
    private Context context;
    private Resources resources;

        public MyButton(Context context,String text,int textSize,int imageResID, int color, onSwipeDeleteButtonListener listener) {
            this.text = text;
